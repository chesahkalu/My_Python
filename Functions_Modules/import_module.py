...
ad = __import__("some_functions").adder # this is another way of importing a function from a module, mostly used when module name is unconventional,imports adder ass ad.
from some_functions import intro 
import Functions_Modules.some_functions # this is how to import from a different directory 
