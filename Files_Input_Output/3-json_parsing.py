...
"""note ~loads~ is used to parse the json string while ~load~ is used to parse the file"""
...
with open('person.json', 'w') as json_file: #this opens a file in writing mode
  json.dump(person_dict, json_file) #this writes the dictionary into a file called person.json in json string mode
...
# asuming person_dict was an object in a class, json_format will return a dictionary of the attributes
